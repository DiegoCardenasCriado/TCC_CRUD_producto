...
public class ProductoController {
	...
	public ProductoEntity update(@PathVariable Long id, @RequestBody ProductoEntity productoEntity) {
		...
		if (!op.isEmpty()) {
			...
			productoEntityUpdate.setNum_lote(productoEntity.getNum_lote());
			productoEntityUpdate.setPrecio_compra(productoEntity.getPrecio_compra());
			productoEntityUpdate.setPrecio_venta(productoEntity.getPrecio_venta());
			productoEntityUpdate.setOrigen(productoEntity.getOrigen());
